    ...
    <style>
        * {
        ...
        body::before {
            ...
            width: 600px;
            height: 600px;
            background: radial-gradient(circle, rgba(255, 0, 110, 0.12), transparent);
            border-radius: 50%;
            top: -250px;
            left: 50%;
        ...
        .error-message {
            background: linear-gradient(135deg, rgba(255, 0, 0, 0.8), rgba(220, 0, 78, 0.8));
            color: #ffffff;
            padding: 14px;
            border-radius: 12px;
            margin-bottom: 20px;
